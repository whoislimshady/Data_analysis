...
app.title = "Opioids in the US: CDC Drug Overdose Deaths"
server = app.server
...
app.layout = html.Div(
    ...
    children=[
        html.Div(
            id="header",
            children=[
                html.H4(children="Opioids in the US: CDC Drug Overdose Deaths"),
                html.P(
                    id="description",
                    children="† This is a data set on the Opioid Epidemic that is designed to be easy to use.",
                ),
            ],
        ),
        html.Div(
